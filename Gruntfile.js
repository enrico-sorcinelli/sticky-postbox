...
module.exports = function( grunt ) {
	...
	grunt.initConfig({
		...
		makepot: {
			target: {
				options: {
					...
					potFilename: 'sticky-postbox.pot',
					processPot: function( pot ) {
						...
						pot.headers['report-msgid-bugs-to'] = 'https://github.com/enrico-sorcinelli/sticky-postbox/issues\n';
		...
		checktextdomain: {
			options: {
				text_domain: 'sticky-postbox', // eslint-disable-line camelcase
				keywords: [
					'__:1,2d',
					'_e:1,2d',
					'_x:1,2c,3d',
		...
		checkwpversion: {
			...
			pluginVsInternal: { //Check plugin header version against internal defined version.
				version1: 'plugin',
				version2: grunt.file.read( 'sticky-postbox.php' ).match( /VERSION', '(.*)'/ )[1],
				compare: '=='
			},
			pluginVsCHANGES: {
				version1: 'plugin',
